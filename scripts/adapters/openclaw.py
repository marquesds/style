...
Layout:
- rules/skills/commands -> one managed section in <root>/.openclaw/workspace/AGENTS.md
"""
...
class OpenClawAdapter:
    ...
    def write_all(
        ...
        eligible = [s for s in sources if "openclaw" in s.agents]
        if not eligible:
            return report

        path = target_root / ".openclaw" / "workspace" / "AGENTS.md"
