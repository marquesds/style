...
4. If the requirement is still fuzzy or the blast radius is large, use **skill:requirements-crushing** and get **`Ready-to-Code: YES`** (or a recorded human override) **before** ordered tasks.
